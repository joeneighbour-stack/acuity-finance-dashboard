...
On Sales Performance, all four KPIs use the HubSpot Retail Pipeline only. Opportunities Created and Closed Won are elapsed-period metrics with equivalent prior-FY comparisons. Open Pipeline and Weighted Pipeline are live point-in-time metrics restricted to Negotiation, Verbally Agreed, and Contract Out; closed deals are excluded and current HubSpot stage probabilities drive weighting. Their historical comparison remains unavailable until complete deal-property and stage-probability history can support accurate reconstruction. Exact dates and definitions are shown in the page's Metric methodology disclosure.
