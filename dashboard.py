...
def revenue_contracts(finance: FinanceSnapshot, snapshot) -> None:
    ...
    comparison_metric(cols[1], "customer_lifetime_value", "Customer lifetime value", money(finance.clv, True), finance.clv, snapshot)
    comparison_metric(cols[2], "new_contracts", "New contracts this FY", "{:,}".format(finance.new_contracts), finance.new_contracts, snapshot)
    st.write("")
